...
export const enum CppDurabilityMode {}
export const enum CppHttpType {}
export const enum CppHttpMethod {}
export const enum CppStoreOpType {}
export const enum CppServiceType {}
export const enum CppErrType {}
export const enum CppLogSeverity {}
export const enum CppSdCmdType {}
export const enum CppSdOpFlag {}
export const enum CppSdSpecFlag {}
export const enum CppConnType {}
export const enum CppViewQueryFlags {}
export const enum CppQueryFlags {}
export const enum CppSearchQueryFlags {}
export const enum CppAnalyticsQueryFlags {}
export const enum CppViewQueryRespFlags {}
export const enum CppQueryRespFlags {}
export const enum CppSearchQueryRespFlags {}
export const enum CppAnalyticsQueryRespFlags {}
